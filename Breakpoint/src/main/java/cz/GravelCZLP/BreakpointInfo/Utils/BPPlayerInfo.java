...
public class BPPlayerInfo {
	...
	public static BPPlayerInfo getInfoAboutPlayer(BPPlayer bpPlayer) {
		...
		return new BPPlayerInfo(stats, achivements, perks, c, game, props, bpPlayer.isInLobby(), prefix);
	}
	...
	public BPPlayerInfo(PlayerStatistics stats, List<Achievement> achive, List<Perk> perks, Clan clan, Game g, GameProperties props, boolean isInLobby, String p) {
		this.stats = stats;
