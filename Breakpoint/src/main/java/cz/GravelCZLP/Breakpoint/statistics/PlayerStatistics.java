...
public class PlayerStatistics extends Statistics {
	...
	public boolean areDefault() {
		if (getKills() != 0 || getAssists() != 0 || getDeaths() != 0 || getMoney() != 0 || getBought() != 0
				|| getFlagTakes() != 0 || getFlagCaptures() != 0) {
			return false;
		}
	...
	public void increaseKills(int by, CharacterType ct) {
		this.ctKills.put(ct, this.ctKills.get(ct) + by);
	}
