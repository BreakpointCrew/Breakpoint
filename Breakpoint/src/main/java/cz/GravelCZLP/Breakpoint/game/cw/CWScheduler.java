...
public class CWScheduler {
	...
	public static String getDayName(int index) {
		...
		case Calendar.SUNDAY:
			return MessageType.CALENDAR_DAY_SUNDAY.getTranslation().getValue();
		case Calendar.MONDAY:
			return MessageType.CALENDAR_DAY_MONDAY.getTranslation().getValue();
		case Calendar.TUESDAY:
			return MessageType.CALENDAR_DAY_TUESDAY.getTranslation().getValue();
		case Calendar.WEDNESDAY:
			return MessageType.CALENDAR_DAY_WEDNESDAY.getTranslation().getValue();
		case Calendar.THURSDAY:
			return MessageType.CALENDAR_DAY_THURSDAY.getTranslation().getValue();
		case Calendar.FRIDAY:
			return MessageType.CALENDAR_DAY_FRIDAY.getTranslation().getValue();
		case Calendar.SATURDAY:
			return MessageType.CALENDAR_DAY_SATURDAY.getTranslation().getValue();
		default:
			return null;
		}
	}
