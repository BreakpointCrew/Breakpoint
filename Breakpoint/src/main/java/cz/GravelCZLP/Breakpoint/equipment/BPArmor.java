...
public class BPArmor extends BPEquipment {
	...
	public BPArmor clone() {
		return new BPArmor(this.typeId, this.rgb, getName(), getMinutesLeft());
	}
	...
	protected ItemStack getItemStackRaw() {
		Material mat = getMaterial(this.typeId);
		ItemStack is = new ItemStack(mat);
		LeatherArmorMeta im = (LeatherArmorMeta) is.getItemMeta();
		im.setDisplayName(getName());
		is.setItemMeta(im);
		colorArmor(is, this.rgb);
		return is;
	}

	public void colorArmor(ItemStack armor) {
		colorArmor(armor, this.rgb);
	}
	...
	protected String serializeRaw() {
		return this.typeId + "," + this.rgb + "," + getName() + "," + getMinutesLeft();
	}
