...
public abstract class StatisticRenderer extends BPMapRenderer {
	public static final byte[] BACKGROUND_COLORS = { BPMapPalette.getColor(BPMapPalette.DARK_BROWN, 0),
			BPMapPalette.getColor(BPMapPalette.DARK_BROWN, 1), BPMapPalette.getColor(BPMapPalette.DARK_BROWN, 2),
			BPMapPalette.getColor(BPMapPalette.DARK_BROWN, 1), BPMapPalette.getColor(BPMapPalette.DARK_BROWN, 0), };
	...
	public void render(MapView view, MapCanvas canvas, Player player) {
		...
		drawCenteredText(canvas, this.label, LABEL_COLOR,
				-MinecraftFont.Font.getHeight() * FONT_SCALE_Y - FONT_DISTANCE_FROM_CENTER);

		if (value != null) {
			drawCenteredText(canvas, value, this.color, FONT_DISTANCE_FROM_CENTER);
		}

		drawBorder(canvas, this.color, BORDER);
	}
