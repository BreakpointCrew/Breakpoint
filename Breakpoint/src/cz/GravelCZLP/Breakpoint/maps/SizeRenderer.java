...
public class SizeRenderer extends BPMapRenderer {
	...
	public void drawSize(MapCanvas canvas) {
		...
		drawRectangle(canvas, 0, 0, MAP_SIZE, MAP_SIZE, this.backgroundColor);
		drawText(canvas, startX, startY, fontWidth, fontHeight, MinecraftFont.Font, sSize, this.foregroundColor);
	}
