...
public class Attributes {
	...
	public static class Attribute {
		...
		private Attribute(Builder builder) {
			this.data = NbtFactory.ofCompound("");
	...
	public void clear() {
		this.attributes.getValue().clear();
	}
	...
	public Attribute get(int index) {
		return new Attribute((NbtCompound) this.attributes.getValue().get(index));
	}
	...
	public Iterable<Attribute> values() {
		return new Iterable<Attribute>() {
			...
			public Iterator<Attribute> iterator() {
				...
				return Iterators.transform(Attributes.this.attributes.getValue().iterator(),
